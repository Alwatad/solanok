...
// Seed data for initial Solanok setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Solanok store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Solanok. All rights reserved.',
  },
  settings: {
    siteName: 'Solanok',
